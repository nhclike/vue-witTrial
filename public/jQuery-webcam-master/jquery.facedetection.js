!function($) {
    ...
    var ccv = {
        ...
        grayscale: function(canvas) {
            for (var pix1, pix2, ctx = canvas.getContext("2d"), imageData = ctx && ctx.getImageData(0, 0, canvas.width, canvas.height), data = imageData.data, pix = canvas.width * canvas.height * 4; pix > 0; ) data[pix -= 4] = data[pix1 = pix + 1] = data[pix2 = pix + 2] = .3 * data[pix] + .59 * data[pix1] + .11 * data[pix2];
