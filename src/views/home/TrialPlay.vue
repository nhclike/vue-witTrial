 ...
 * @Last Modified time: 2021-02-03 15:23:37
 */
...
export default {
    ...
    methods: {
        ...
        playVideo(index) {
            ...
            console.log('playParams', playParams);
            this.videoPlay(playParams);
            // this.curPlayIndex = this.findIndex(playUrl);
            this.$emit('emitDotLinkTo', this.recordList[index].dotTimeStamp);
        ...
        onPlayerEnded(player) {
            ...
            console.log('this.curPlayIndex', this.activeIndex);
            if (this.activeIndex >= this.recordList.length - 1) {
                ...
                this.videoPlay({
                    type: 'video/mp4', // http
                    src: this.recordList[this.activeIndex].fileUrl
                });
        ...
        findIndex(str) {
            for (let i = 0; i < this.recordList.length; i++) {
                if (str == this.recordList[i].fileUrl) {
                    return i;
                }
            }
            return -1;
