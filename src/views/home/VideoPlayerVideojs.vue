<!--
 * @Descripttion: 视频播放电子卷宗和影音证据的视频播放---videojs播放器
 * @Author: zhangt
 * @Date: 2021-05-12 14:44:40
 * @Last Modified by: zhangt
 * @Last Modified time: 2021-05-13 10:45:06
-->

<template>
  <div class="full-height" ref="dotPage">
    <div class="video-box full-height" v-if="showVideo" ref="videoPlayerBox">
        <video-player
